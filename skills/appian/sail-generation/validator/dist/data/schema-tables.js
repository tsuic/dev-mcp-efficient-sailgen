...
const MARGIN_VALUES = ["NONE", "EVEN_LESS", "LESS", "STANDARD", "MORE", "EVEN_MORE"];
const LABEL_POSITION_VALUES = ["ABOVE", "ADJACENT", "JUSTIFIED", "COLLAPSED"];
const PADDING_VALUES = ["NONE", "EVEN_LESS", "LESS", "STANDARD", "MORE", "EVEN_MORE"];
const SHAPE_VALUES = ["SQUARED", "SEMI_ROUNDED", "ROUNDED"];
const ALIGN_LCR = ["LEFT", "CENTER", "RIGHT"];
const ALIGN_SCE = ["START", "CENTER", "END"];
const SIZE_STANDARD = ["TINY", "SMALL", "MEDIUM", "LARGE"];
const CONTENTS_WIDTH = ["EXTRA_NARROW", "NARROW", "MEDIUM", "WIDE", "FULL"];
const HEADING_TAG = ["H1", "H2", "H3", "H4", "H5", "H6"];
const LABEL_SIZE = ["LARGE_PLUS", "LARGE", "MEDIUM_PLUS", "MEDIUM", "SMALL", "EXTRA_SMALL"];
const COLUMN_WIDTH = ["AUTO", "EXTRA_NARROW", "NARROW", "NARROW_PLUS", "MEDIUM", "MEDIUM_PLUS", "WIDE", "WIDE_PLUS", "EXTRA_WIDE", "1X", "2X", "3X", "4X", "5X", "6X", "7X", "8X", "9X", "10X"];
const PANE_WIDTH = ["AUTO", "EXTRA_NARROW", "NARROW", "NARROW_PLUS", "MEDIUM", "MEDIUM_PLUS", "WIDE", "WIDE_PLUS"];
const HEIGHT_CARDS = ["EXTRA_SHORT", "SHORT", "SHORT_PLUS", "MEDIUM", "MEDIUM_PLUS", "TALL", "TALL_PLUS", "EXTRA_TALL", "AUTO"];
const CHART_HEIGHT = ["MICRO", "SHORT", "MEDIUM", "TALL"];
const COLOR_SCHEME = ["CLASSIC", "MIDNIGHT", "OCEAN", "MOSS", "BERRY", "PARACHUTE", "RAINFOREST", "SUNSET"];
const CHART_STACKING = ["NONE", "NORMAL", "PERCENT_TO_TOTAL"];
const REFRESH_AFTER_TEXT = ["KEYPRESS", "UNFOCUS"];
const BG_COLOR_FORM = ["WHITE", "TRANSPARENT", "CHARCOAL_SCHEME", "NAVY_SCHEME", "PLUM_SCHEME"];
const OVERLAY_STYLE = ["DARK", "SEMI_DARK", "NONE", "SEMI_LIGHT", "LIGHT"];
/**
