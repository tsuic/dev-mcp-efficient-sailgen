 ...
 */
export function checkLayoutConstraints(source, lines) {
    const errors = [];
 ...
 */
function checkColumnsAutoWidth(lines, errors) {
 ...
 * - Maximum 3 panes
 */
function checkPaneConstraints(lines, errors) {
 ...
 */
function checkSideBySideNesting(lines, errors) {
    let inSBSItem = false;
    let sbsStart = -1;
    let depth = 0;
    let inString = false;
